...
stargazer(mylogit, type = "text",
          ...
          aling = TRUE, digits=7,
          dep.var.labels = "Pobre",
          covariate.labels = c("ingreso", "cabecera","cuartos","v. propia pagadando", "v. arriendo","v.usufructo",
                               "posesion sin titulo","otro tipo vivienda","No personas hogar","hombre","edad","educación superior",
                               "horas de trabajo")
)
